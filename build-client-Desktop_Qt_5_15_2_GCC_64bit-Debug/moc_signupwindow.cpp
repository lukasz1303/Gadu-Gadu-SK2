...
#include <memory>
#include "../clientGUI/signupwindow.h"
...
QT_MOC_LITERAL(1, 13, 10), // "showParent"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 23), // "on_signUpButton_clicked"
QT_MOC_LITERAL(4, 49, 8) // "readData"

    },
    "SignUpWindow\0showParent\0\0"
    "on_signUpButton_clicked\0readData"
};
...
void SignUpWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SignUpWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignUpWindow::showParent)) {
                *result = 0;
                return;
            }
        }
